...
public class WindowElement: UIElement {
    ...
    public var toolbar: ToolbarElement? {
        get{
            guard let children = try? accessibilityElement.children(),
                  let toolbar = children.firstAndOnly(where: { $0.role == .toolbar }) else {
                return nil
            }
    ...
    public var title: String? {
        get {
            return try? accessibilityElement.value(forAttribute: .title)
        }
    }
}
