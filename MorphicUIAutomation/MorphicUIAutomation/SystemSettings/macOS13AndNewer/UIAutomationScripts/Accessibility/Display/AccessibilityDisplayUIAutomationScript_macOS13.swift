...
public class AccessibilityDisplayUIAutomationScript_macOS13 {
    ...
    public static func setColorFiltersIntensity(_ value: Double, sequence: UIAutomationSequence? = nil, waitAtMost: TimeInterval) async throws {
        ...
        try await Self.setAndVerifySliderValue(closestTo: value, forSliderWithIdentifier: SystemSettingsAccessibilityDisplayCategoryPane_macOS13.Slider.colorFiltersIntensity, waitAtMost: waitAtMost)
    }
    ...
    public static func setColorFiltersAreEnabled(_ value: Bool, sequence: UIAutomationSequence? = nil, waitAtMost: TimeInterval) async throws {
        ...
        try await Self.setAndVerifyCheckboxValue(value, forCheckboxWithIdentifier: SystemSettingsAccessibilityDisplayCategoryPane_macOS13.Checkbox.colorFilters, waitAtMost: waitAtMost)
    }
    ...
    public static func setDifferentiateWithoutColorIsOn(_ value: Bool, sequence: UIAutomationSequence? = nil, waitAtMost: TimeInterval) async throws {
        ...
        try await Self.setAndVerifyCheckboxValue(value, forCheckboxWithIdentifier: SystemSettingsAccessibilityDisplayCategoryPane_macOS13.Checkbox.differentiateWithoutColor, waitAtMost: waitAtMost)
    }
    ...
    public static func setInvertColorsIsOn(_ value: Bool, sequence: UIAutomationSequence? = nil, waitAtMost: TimeInterval) async throws {
        ...
        try await Self.setAndVerifyCheckboxValue(value, forCheckboxWithIdentifier: SystemSettingsAccessibilityDisplayCategoryPane_macOS13.Checkbox.invertColors, waitAtMost: waitAtMost)
    }
    ...
    public static func setInvertColorsMode(_ value: AccessibilityDisplaySettings.InvertColorsMode, sequence: UIAutomationSequence? = nil, waitAtMost: TimeInterval) async throws {
        ...
        let radioButton: SystemSettingsAccessibilityDisplayCategoryPane_macOS13.InvertColorsModeRadioButton
        switch value {
        case .classic:
            radioButton = .classic
        case .smart:
        ...
        try await Self.selectAndVerifyRadioGroupButton(radioButton, forRadioGroupWithIdentifier: SystemSettingsAccessibilityDisplayCategoryPane_macOS13.RadioGroup.invertColorsMode, waitAtMost: waitAtMost)
    }
    ...
    public static func setPointerSize(_ value: Double, sequence: UIAutomationSequence? = nil, waitAtMost: TimeInterval) async throws {
        ...
        // NOTE: due to a limitation (or temporary issue) in macOS 13, we are unable to set the exactly value of a slider; instead we move the slider to the value "closest to" the target
        try await Self.setAndVerifySliderValue(closestTo: value, forSliderWithIdentifier: SystemSettingsAccessibilityDisplayCategoryPane_macOS13.Slider.pointerSize, waitAtMost: waitAtMost)
    }
    ...
    public static func setReduceMotionIsOn(_ value: Bool, sequence: UIAutomationSequence? = nil, waitAtMost: TimeInterval) async throws {
        ...
        try await Self.setAndVerifyCheckboxValue(value, forCheckboxWithIdentifier: SystemSettingsAccessibilityDisplayCategoryPane_macOS13.Checkbox.reduceMotion, waitAtMost: waitAtMost)
    }
    ...
    public static func setIncreaseContrastIsOn(_ value: Bool, sequence: UIAutomationSequence? = nil, waitAtMost: TimeInterval) async throws {
        ...
        try await Self.setAndVerifyCheckboxValue(value, forCheckboxWithIdentifier: SystemSettingsAccessibilityDisplayCategoryPane_macOS13.Checkbox.increaseContrast, waitAtMost: waitAtMost)
    }
    ...
    public static func setReduceTransparencyIsOn(_ value: Bool, sequence: UIAutomationSequence? = nil, waitAtMost: TimeInterval) async throws {
        ...
        try await Self.setAndVerifyCheckboxValue(value, forCheckboxWithIdentifier: SystemSettingsAccessibilityDisplayCategoryPane_macOS13.Checkbox.reduceTransparency, waitAtMost: waitAtMost)
    }
    ...
    public static func setShakeMousePointerToLocateIsOn(_ value: Bool, sequence: UIAutomationSequence? = nil, waitAtMost: TimeInterval) async throws {
        ...
        try await Self.setAndVerifyCheckboxValue(value, forCheckboxWithIdentifier: SystemSettingsAccessibilityDisplayCategoryPane_macOS13.Checkbox.shakeMousePointerToLocate, waitAtMost: waitAtMost)
    }
