...
public class AccessibilityVoiceOverUIAutomationScript_macOS13 {
    public static func setVoiceOverIsOn(_ value: Bool, sequence: UIAutomationSequence? = nil, waitAtMost: TimeInterval) async throws {
        ...
        try await Self.setAndVerifyCheckboxValue(value, forCheckboxWithIdentifier: SystemSettingsAccessibilityVoiceOverCategoryPane_macOS13.Checkbox.voiceOver, waitAtMost: waitAtMost)
    }
