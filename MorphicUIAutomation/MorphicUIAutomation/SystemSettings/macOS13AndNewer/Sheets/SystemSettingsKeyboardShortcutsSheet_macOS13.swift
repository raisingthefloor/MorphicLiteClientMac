...
//                return "Screenshots"
    ...
    public func navigateTo(_ pane: CategoryPane, waitAtMost: TimeInterval) async throws -> GroupUIElement {
        ...
        let categoryLabel = SystemSettingsKeyboardShortcutsSheet_macOS13.labelForCategory(pane)
        //
        ...
        //
        let requiredStaticTextValue = SystemSettingsKeyboardShortcutsSheet_macOS13.seekLabelForCategory(pane)
        //
