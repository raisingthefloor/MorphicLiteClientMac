...
internal class SystemSettingsGeneralCategoryPane_macOS13 {
    ...
    public func navigateTo(_ pane: CategoryPane, waitAtMost: TimeInterval) async throws -> GroupUIElement {
        ...
        let categoryLabel = SystemSettingsGeneralCategoryPane_macOS13.labelForCategory(pane)
        //
        ...
        //
        let requiredWindowTitle = SystemSettingsGeneralCategoryPane_macOS13.windowTitleForCategory(pane)
        //
