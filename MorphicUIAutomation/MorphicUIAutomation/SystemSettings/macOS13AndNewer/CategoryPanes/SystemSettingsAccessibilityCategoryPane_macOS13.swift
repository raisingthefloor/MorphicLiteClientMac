...
internal class SystemSettingsAccessibilityCategoryPane_macOS13: SystemSettingsGroupUIElementWrapper {
    ...
    public func navigateTo(_ pane: CategoryPane, waitAtMost: TimeInterval) async throws -> GroupUIElement {
        ...
        let categoryIdentifier = SystemSettingsAccessibilityCategoryPane_macOS13.identifierForCategory(pane)
        //
        ...
        //
        let requiredWindowTitle = SystemSettingsAccessibilityCategoryPane_macOS13.windowTitleForCategory(pane)
        //
