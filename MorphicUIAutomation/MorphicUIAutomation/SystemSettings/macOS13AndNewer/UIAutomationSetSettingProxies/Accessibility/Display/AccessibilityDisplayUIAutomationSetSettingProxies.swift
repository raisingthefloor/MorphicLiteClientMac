...
public class IncreaseColorsUIAutomationSetSettingProxy: UIAutomationSetSettingProxy {
    ...
    public func apply(_ value: Interoperable?) async throws {
        ...
        let waitForTimespan = UIAutomationApp.defaultMaximumWaitInterval
        try await AccessibilityDisplayUIAutomationScript_macOS13.setInvertColorsIsOn(valueAsBool, waitAtMost: waitForTimespan)
    }
}
...
public class InvertClassicUIAutomationSetSettingProxy: UIAutomationSetSettingProxy {
    ...
    public func apply(_ value: Interoperable?) async throws {
        ...
        let waitForTimespan = UIAutomationApp.defaultMaximumWaitInterval
        try await AccessibilityDisplayUIAutomationScript_macOS13.setInvertColorsMode(valueAsInvertColorsMode, waitAtMost: waitForTimespan)
    }
}
...
public class ReduceMotionUIAutomationSetSettingProxy: UIAutomationSetSettingProxy {
    ...
    public func apply(_ value: Interoperable?) async throws {
        ...
        let waitForTimespan = UIAutomationApp.defaultMaximumWaitInterval
        try await AccessibilityDisplayUIAutomationScript_macOS13.setReduceMotionIsOn(valueAsBool, waitAtMost: waitForTimespan)
    }
}
...
public class ReduceTransparencyUIAutomationSetSettingProxy: UIAutomationSetSettingProxy {
    ...
    public func apply(_ value: Interoperable?) async throws {
        ...
        let waitForTimespan = UIAutomationApp.defaultMaximumWaitInterval
        try await AccessibilityDisplayUIAutomationScript_macOS13.setReduceTransparencyIsOn(valueAsBool, waitAtMost: waitForTimespan)
    }
}
...
public class DifferentiateWithoutColorUIAutomationSetSettingProxy: UIAutomationSetSettingProxy {
    ...
    public func apply(_ value: Interoperable?) async throws {
        ...
        let waitForTimespan = UIAutomationApp.defaultMaximumWaitInterval
        try await AccessibilityDisplayUIAutomationScript_macOS13.setDifferentiateWithoutColorIsOn(valueAsBool, waitAtMost: waitForTimespan)
    }
}
...
public class CursorShakeUIAutomationSetSettingProxy: UIAutomationSetSettingProxy {
    ...
    public func apply(_ value: Interoperable?) async throws {
        ...
        let waitForTimespan = UIAutomationApp.defaultMaximumWaitInterval
        try await AccessibilityDisplayUIAutomationScript_macOS13.setShakeMousePointerToLocateIsOn(valueAsBool, waitAtMost: waitForTimespan)
    }
}
...
public class CursorSizeUIAutomationSetSettingProxy: UIAutomationSetSettingProxy {
    ...
    public func apply(_ value: Interoperable?) async throws {
        ...
        let waitForTimespan = UIAutomationApp.defaultMaximumWaitInterval
        try await AccessibilityDisplayUIAutomationScript_macOS13.setPointerSize(valueAsDouble, waitAtMost: waitForTimespan)
    }
}
...
//        //
//        let waitForTimespan = UIAutomationApp.defaultMaximumWaitInterval
//        try await AccessibilityDisplayUIAutomationScript_macOS13.setColorFiltersAreEnabled(valueAsBool, waitAtMost: waitForTimespan)
    }
...
public class ColorFilterTypeUIAutomationSetSettingProxy: UIAutomationSetSettingProxy {
    ...
    public func setColorFilterType(_ value: MorphicSettings.AccessibilityDisplaySettings.ColorFilterType, waitAtMost: TimeInterval) async throws {
        ...
        do {
            let waitForTimespan = max(waitAbsoluteDeadline - ProcessInfo.processInfo.systemUptime, 0)
            try await AccessibilityDisplayUIAutomationScript_macOS13.setColorFilterType(value, sequence: uiAutomationSequence, waitAtMost: waitForTimespan)
        } catch let error {
            throw error
        }
...
public class ColorFilterIntensityUIAutomation: UIAutomationSetSettingProxy {
    ...
    public func apply(_ value: Interoperable?) async throws {
        ...
        let waitForTimespan = UIAutomationApp.defaultMaximumWaitInterval
        try await AccessibilityDisplayUIAutomationScript_macOS13.setColorFiltersIntensity(valueAsDouble, waitAtMost: waitForTimespan)
    }
}
