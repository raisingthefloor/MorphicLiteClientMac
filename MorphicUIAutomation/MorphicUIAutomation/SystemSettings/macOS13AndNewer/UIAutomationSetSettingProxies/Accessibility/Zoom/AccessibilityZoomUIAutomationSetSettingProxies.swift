    ...
    public func setMagnifierIsOn(_ value: Bool, waitAtMost: TimeInterval) async throws {
        ...
        do {
            ...
            if hotkeysEnabled == false {
                ...
                try await AccessibilityZoomUIAutomationScript_macOS13.setHotkeysEnabled(value, sequence: uiAutomationSequence, waitAtMost: waitForTimespan)
            }
        } catch let error {
            throw error
        }
...
public class ScrollToZoomEnabledUIAutomation: UIAutomationSetSettingProxy {
    ...
    public func apply(_ value: Interoperable?) async throws {
        ...
        let waitForTimespan = UIAutomationApp.defaultMaximumWaitInterval
        try await AccessibilityZoomUIAutomationScript_macOS13.setUseScrollGestureWithModifierKeysToZoomIsOn(valueAsBool, waitAtMost: waitForTimespan)
    }
}
...
public class HoverTextEnabledUIAutomation: UIAutomationSetSettingProxy {
    ...
    public func apply(_ value: Interoperable?) async throws {
        ...
        let waitForTimespan = UIAutomationApp.defaultMaximumWaitInterval
        try await AccessibilityZoomUIAutomationScript_macOS13.setHoverTextIsOn(valueAsBool, waitAtMost: waitForTimespan)
    }
}
...
public class TouchbarZoomEnabledUIAutomation: UIAutomationSetSettingProxy {
    ...
    public func apply(_ value: Interoperable?) async throws {
        ...
        let waitForTimespan = UIAutomationApp.defaultMaximumWaitInterval
        try await AccessibilityZoomUIAutomationScript_macOS13.setUseTrackpadGestureToZoomIsOn(valueAsBool, waitAtMost: waitForTimespan)
    }
}
...
public class ZoomStyleUIAutomation: UIAutomationSetSettingProxy {
    ...
    public func apply(_ value: Interoperable?) async throws {
        ...
        let waitForTimespan = UIAutomationApp.defaultMaximumWaitInterval
        try await AccessibilityZoomUIAutomationScript_macOS13.setZoomStyle(valueAsZoomStyle, waitAtMost: waitForTimespan)
    }
}
